...
@section('body')
<div class="panel">
    <form class="form-horizontal" action="{{url('/orderoutcreate')}}" method="post">
        <!--Modal body-->
        <div class="row">
            <div class="col-lg-12">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label" for="demo-is-inputsmall">售价</label>
                            <div class="col-sm-6">
                                <input name="prices" type="text" placeholder="售价"
                                       class="form-control input-sm" id="demo-is-inputsmall">
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-sm-9 col-sm-offset-3">
                            <button class="btn btn-mint" type="submit">售出</button>
